...
<main class="container mt-4 mb-5">
    <div class="text-center mb-4">
        <h1 class="h3 fw-bold" style="color: var(--afa-azul-oscuro);">Ranking General</h1>
        <p class="text-muted small">Tabla de posiciones del Prode Mundial 2026</p>
    </div>
...
<c:if test="${not empty sessionScope.usuarioLogueado}">
    <div class="fixed-bottom p-3" style="z-index: 1040; bottom: 70px;">
        <div class="container d-flex justify-content-center p-0">
            <div class="col-12 col-md-8 col-lg-5">
                <%-- Estilo AFA para tu tarjeta personal --%>
                <div class="d-flex align-items-center p-3 rounded-4 border border-warning shadow-lg"
                    ...
                    <div class="me-3">
                        <div class="bg-white border border-warning rounded-3 px-2 py-1 text-center" style="min-width: 45px;">
                            <span class="fw-bold small" style="color: var(--afa-amarillo);">TÚ</span>
                        </div>
                    </div>

                    <div class="flex-grow-1" style="min-width: 0;">
                        <h6 class="mb-0 fw-bold text-truncate" style="font-size: 0.9rem; color: var(--afa-azul-oscuro);">
                            ${not empty sessionScope.usuarioLogueado.nombreGrupo ? sessionScope.usuarioLogueado.nombreGrupo : 'Mi Perfil'}
                        </h6>
                        <div class="text-muted" style="font-size: 0.65rem; line-height: 1.1;">
                            <span class="d-block text-truncate text-uppercase">${sessionScope.usuarioLogueado.carrera.descripcion}</span>
                            <span class="fw-bold text-uppercase text-secondary">${sessionScope.usuarioLogueado.curso}</span>
                        </div>
                    </div>

                    <div class="text-end ms-2">
                        <span class="fw-bold fs-5 d-block" style="color: var(--afa-azul-oscuro);">${sessionScope.usuarioLogueado.puntajeTotal}</span>
