...
<main>
  <!-- Envolvemos con hero-inicio para dar el fondo degradado de la Selección -->
  <div class="hero-inicio countdown-section text-center">

    <h1 class="text-uppercase mb-3 fw-bold"
        style="color: var(--afa-azul-oscuro); font-size: 1.8rem; letter-spacing: 1px;">
      ¡BIENVENIDO!
    </h1>

    <!-- Usamos la base de countdown-box pero adaptada para el reloj -->
    <div class="countdown-box shadow-lg my-2 mx-auto" style="max-width: 320px;">
      <div class="countdown-inner">
        <div id="countdown-reloj" class="font-monospace text-center" style="letter-spacing: 2px; font-size: 1.8rem;">
          00:00:00:00
        </div>
        <div class="d-flex justify-content-between text-uppercase fw-bold mt-1 px-1"
             style="font-size: 0.65rem; color: var(--afa-blanco); opacity: 0.85; letter-spacing: 1px;">
          <span style="width: 25%;">Días</span>
          <span style="width: 25%;">Horas</span>
          <span style="width: 25%;">Min</span>
          <span style="width: 25%;">Seg</span>
        </div>
      </div>
    </div>

    <h3 class="text-uppercase fw-bold mt-3 mb-2"
        style="color: var(--afa-azul-oscuro); font-size: 1.1rem; letter-spacing: 1px;">
      Para el Mundial
    </h3>
  </div>
