...
public class JugadaServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    // FIX: Redirección limpia pasando la jornada para evitar cruce de datos con la jornada 1
  ...
  private void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try {
      ...
      if (!fechasDisponibles.isEmpty()) {
        ...
        request.setAttribute("mapaJugadas", mapaJugadas); // <--- FIX: Enviado con éxito al request
